export const day1 = {
  ...
  places: [
    ...
    },
    {
      ...
      lat: 33.486746, lng: 126.490847, address: '35 Yeondong 7-gil, Jeju-si, Jeju-do', note: '想吃一顿代表性济州黑猪时优先',
    },
    {
      id: 'jokbal', name: '贵韩猪蹄 · 新济州店', koreanName: '귀한족발 신제주점', category: 'restaurant', status: 'candidate',
      lat: 33.490949, lng: 126.494754, address: '18 Sindae-ro 10-gil, Jeju-si, Jeju-do', note: '想吃轻松的韩式猪蹄/包肉时选择',
    },
  ],
  restaurantNotes: [
